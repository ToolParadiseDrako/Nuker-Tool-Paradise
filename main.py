...
loop()
ctypes.windll.kernel32.SetConsoleTitleW(f"『 Drako 』 By ~Tool Paradise~ / Tokens: {lol} ")
def Server_Joiner_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 Drako 』 By ~Tool Paradise~ / Tokens: {lol} | Joined : {Joined}")
...
def Token_Checker_title():
    ...
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 Drako 』 By ~Tool Paradise~ / Tokens: {lol} | Tokens Checked : {Token_checked} ~ Valid Tokens : {valid_tokens} ~ Verified Tokens: {verified_tokens} ~ Nitro Tokens : {Tokens_withnitro}")

def Server_Spammer_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 Drako 』 By ~Tool Paradise~ / Tokens: {lol} | Messages Send : {Message_send}")
 
def Webhook_Deleter_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 Drako 』 By ~Tool Paradise~ / Tokens: {lol} | Webhooks Deleted : {Deleted}")
...
def VC_joiner_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 Drako 』 By ~Tool Paradise~ / Tokens: {lol} | Vc Joined : {vc_joined}")

def Pfp_Changer_title():
    global Joined,Token_checked,Message_send,Deleted,vc_joined,pfp_changed,nickname_changed
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 Drako 』 By ~Tool Paradise~ / Tokens: {lol} | Pfp Changed : {pfp_changed}")
...
def Nickname__bio_Changer_title():
    ...
    ctypes.windll.kernel32.SetConsoleTitleW(f"『 Drako 』 By ~Tool Paradise~ / Tokens: {lol} | Nicknames Changed : {nickname_changed} ~ Bios Changed : {bio_changed}")
...
def Nickname__bio_Changer(session,token,nickname,bio):
    ...
    if change_nickname.status_code == 200:
        with output_lock:
            ...
            sys.stdout.flush()
            Write.Print(f"{token}", Colors.red_to_white, interval=0.000)
        ...
        with output_lock:
            ...
            sys.stdout.flush()
            Write.Print(f"Captcha Required", Colors.red_to_white, interval=0.000)
            Nickname__bio_Changer_title() 
    else:
        with output_lock:
            time_rn = get_time()
    ...
    Write.Print(f'''
                        ...
                        •██  ▪     ▪     ██•      ▐█ ▄█▐█ ▀█ ▀▄ █·▐█ ▀█ ██▪ ██ ██ ▐█ ▀. ▀▄.▀·
                         ...
                         [+] Proxies > {proxies}                                                                                                                      
                                ...
                                by ~Tool Paradise~ | https://github.com/ToolParadiseDrako
════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════                  
    ...
    , Colors.red_to_white, interval=0.000)
    choice = input(f""" {blue}
┌──{red}(TOOL PARADISE){blue} ~ [{red}Ϟ{blue}]
└─> """)
    threads = []
    session = check_useproxies()
    ...
    if choice == '03' or choice == '3':
        ...
        for thread in threads:
            thread.join()
        print('\n')
        Write.Print('[!] Calculating Stats...', Colors.red_to_white, interval=0.002)
...
''')
    ...
    if choice == '06' or choice == '6':
        ...
        for thread in threads:
            thread.join()
        Write.Print(f'\n [!] Finished! {vc_joined} Tokens Joined Vc!', Colors.red_to_white, interval=0.009)
        input(f'{reset}\n Enter to go back!')
        clear_screen()
        Write.Print('Give it a star or you gay ',Colors.red, interval=0.000)
        time.sleep(2)
    ...
    if choice == '07' or choice == '7':
        ...
        for thread in threads:
            thread.join()
        Write.Print(f'\n [!] Finished! Changed : {nickname_changed} Nicknames | Changed : {bio_changed} Bios!', Colors.red_to_white, interval=0.009)
        input(f'{reset}\n Enter to go back!')
        clear_screen()
        Write.Print('Give it a star or you gay ',Colors.red, interval=0.000)
        time.sleep(2)
    ...
    if choice == '08' or choice == '8':
        ...
        for thread in threads:
            thread.join()
        Write.Print(f'\n [!] Finished! Send : {Message_send} To {member_id}', Colors.red_to_white, interval=0.009)
        input(f'{reset}\n Enter to go back!')
        clear_screen()
        Write.Print('Give it a star or you gay ',Colors.red, interval=0.000)
        time.sleep(2)
    ...
    if choice == '09' or choice == '9':
        ...
        for thread in threads:
            thread.join()
        Write.Print(f'\n [!] Finished! Changed Pfp To : {pfp_changed} Tokens', Colors.red_to_white, interval=0.009)
        input(f'{reset}\n Enter to go back!')
        clear_screen()
        Write.Print('Give it a star or you gay ',Colors.red, interval=0.000)
        time.sleep(2)
